...
def main():
    ...
    if gemini_key:
        ...
        # Reformat for the client as main.py does
        analysis_input = [{"symbol": p["symbol"], "company": p["company"], "quantity": p["quantity"], "marketValue": p["marketValue"]} for p in sample_portfolio]
